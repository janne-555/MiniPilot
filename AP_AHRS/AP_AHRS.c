...
float AP_AHRS_GetRoll(void) { return ahrs.roll; }

float AP_AHRS_GetPitch(void) { return ahrs.pitch; }

float AP_AHRS_GetYaw(void) { return ahrs.yaw; }

uint8_t AP_AHRS_IsHealthy(void) { return ahrs.healthy; }
