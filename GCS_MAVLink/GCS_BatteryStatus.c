...
void GCS_send_battery_status(void) {
  ...
  uint16_t voltages[10] = {UINT16_MAX, UINT16_MAX, UINT16_MAX, UINT16_MAX,
                           UINT16_MAX, UINT16_MAX, UINT16_MAX, UINT16_MAX,
                           UINT16_MAX, UINT16_MAX};

  voltages[0] = (uint16_t)(bat->voltage * 1000.0f);

  //-------------------------------------
  // extended voltages
  //-------------------------------------

  uint16_t voltages_ext[4] = {UINT16_MAX, UINT16_MAX, UINT16_MAX, UINT16_MAX};
  ...
  mavlink_msg_battery_status_pack(
      ...
      (int16_t)(bat->current * 100.0f), // centi amps

      -1, // consumed mAh unknown

      -1, // energy unknown

      (int8_t)bat->remaining_percent,
