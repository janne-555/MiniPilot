...
void GCS_send_home_position(void) {
  ...
  int32_t latitude = (int32_t)(home->latitude * 10000000.0);

  int32_t longitude = (int32_t)(home->longitude * 10000000.0);

  int32_t altitude = (int32_t)(home->altitude * 1000.0f);
  ...
  mavlink_msg_home_position_pack(1, 1,
